...
- The release-tile pair waits for at least two animation-frame boundaries and 100 ms after the original `MOUSE_UP`; a 120 Hz WebView with a 30 Hz Cocos loop still clears the two-tick `MouseClickCoolingDown` before placement.
