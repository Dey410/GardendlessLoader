...
- On shared-mapped Android GP-Next, iOS, and HarmonyOS sessions, drag release adds exactly one next-frame left click at the final point; stationary taps do not add it.
